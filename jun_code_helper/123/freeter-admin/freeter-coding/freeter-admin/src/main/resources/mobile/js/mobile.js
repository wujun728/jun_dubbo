...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.mobile.id == null ? "mobile/save" : "mobile/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		getInfo: function(id){
			$.get(baseURL + "mobile/info/"+id, function(r){
                vm.mobile = r.mobile;
            });
		},
